...
**결정을 내린 그때 쓴다.** 이 폴더 16건 중 9건의 이유가 비어 있거나 정황 추정인 것은, 전부 나중에 복원하려 했기 때문이다. 나중에는 아무도 기억하지 못한다.
